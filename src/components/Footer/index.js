    ...
    <S.Main id="contato">
      <S.Container>
        ...
        <S.Card>
          <h3>Comunicação</h3>
          <p>
            <S.Icones src={Telefone}></S.Icones>+55 87 99105 4786
          </p>
          <p>
            <S.Icones src={Mensagem}></S.Icones>paulinho_marques2012@hotmail.com
          </p>
          <p>
            <S.Icones src={Gps}></S.Icones>Avenida Osvaldo Cruz 1500
          </p>
        </S.Card>
